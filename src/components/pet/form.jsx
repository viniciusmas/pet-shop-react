                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
                    ...
                    <div className="flex gap-4 w-full">
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <input className="input input-bordered w-full" type="text" id="tipoEspecie" name="tipoEspecie" value={data.tipoEspecie} onChange={handleChange}/>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 w-full">
                        <div className="flex flex-col w-full">
                            ...
                            <input className="input input-bordered w-full" type="text" id="raca" name="raca" value={data.raca} onChange={handleChange}/>
                        </div>

                        <div className="flex flex-col w-full">
                            <label className="label" htmlFor="idade">Idade</label>
                            <input className="input input-bordered w-full" type="text" id="idade" name="idade" value={data.idade} onChange={handleChange}/>
                        </div>
                    </div>
